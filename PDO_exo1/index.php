                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="../PDO2_exo1/changeAppointment.php">Exercice 9 </a>
                                <a class="dropdown-item" href="../PDO2_exo1/liste-rendezvous.php">Exercice 10 </a>
                                <a class="dropdown-item" href="../PDO2_exo1/liste-patients.php">Exercice 11 </a>
                                <a class="dropdown-item" href="../PDO2_exo1/liste-patients.php">Exercice 12  </a>
                                <a class="dropdown-item" href="../PDO2_exo1/liste-patients.php">Exercice 13  </a>
                            </div>
                        </li>
                                <li class="nav-item dropdown">
